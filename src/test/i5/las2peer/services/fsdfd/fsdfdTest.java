 ...
 * 47 - Test Class
 *
 * This class provides a basic testing framework for the microservice 47. It was
 * generated by the CAE (Community Application Framework).
 *
 */
public class fsdfdTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(fsdfd.class.getCanonicalName(),"0.1");

  private static final String mainPath = "hjkj";
  ...
  public void testdsa() {
    ...
    try {
      JSONObject dfsfd = new JSONObject();
      c.setLogin(testAgent.getIdentifier(), testPass);
      ClientResponse result = c.sendRequest("GET", mainPath + "/fsdfs", dfsfd.toJSONString(),
        MediaType.APPLICATION_JSON, MediaType.APPLICATION_JSON, new HashMap<String,String>());
      assertTrue(true); // change here
      System.out.println("Result of 'testdsa': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
